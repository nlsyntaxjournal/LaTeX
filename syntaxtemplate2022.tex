...
%Margin width -- if you stick with Times fonts below, switch to wider margins here:
...
% Linguistic trees: 
\usepackage[nocenter]{qtree} %http://tug.ctan.org/tex-archive/macros/latex/contrib/qtree/
...
%%% ENTER ARTICLE TYPE (change "Regular article" to "Remark" if appropriate)

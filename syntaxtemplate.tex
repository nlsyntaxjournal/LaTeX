...
%%Option A: using \citet for textual citations and (...\citet...) for parenthetical ones:
%%\bibpunct[:]{}{}{,}{a}{}{,}
   %%or%%
%%\setcitestyle{open={},close={},aysep={},notesep={:}}
%%Option B: using \citealt for textual citations and \citep for parenthetical ones:
%%\bibpunct[:]{(}{)}{,}{a}{}{,}
   %%or%%
